...
<div id="page-wrapper">
    <div class="mx-auto flex max-w-9xl flex-col gap-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="page-title">Planification Vidange Exploitation</h1>
                <p class="text-sm text-slate-500">Vue exploitation avec tri par urgence des vidanges nécessaires.</p>
            </div>
        </div>
...
$(document).ready(function() {
    var table = $('#tab').DataTable({
        ...
        order: [[5, "asc"]] // Sort by "Kilomètrage Reste" column (index 5)
    });
});
</script>

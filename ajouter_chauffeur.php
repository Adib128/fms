...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="max-w-9xl mx-auto px-4 py-1">
            <!-- Page Header -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900">Ajouter Chauffeur</h1>
                <p class="mt-2 text-sm text-gray-600">Créer un nouveau chauffeur dans le système</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8">
                <form class="space-y-8" enctype="multipart/form-data" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-10 gap-6 items-center">
                        ...
                        <div class="md:col-span-8">
                            <input type="text" id="matricule" name="matricule" required
                                ...
                                placeholder="Entrez le matricule du chauffeur">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-10 gap-6 items-center">
                        ...
                        <div class="md:col-span-8">
                            <input type="text" id="nom_prenom" name="nom_prenom" required
                                class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200"
                                placeholder="Entrez le nom et prénom du chauffeur">
                        </div>
                    </div>
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == 'POST') {
                        ...
                        $select = $db->query("SELECT * FROM chauffeur WHERE matricule='$matricule'");
                        $e = $select->fetch(PDO::FETCH_NUM);
                        if ($e > 0) {
                            echo "<div class='bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg'>Chauffeur déjà existe</div>";
                        } else {

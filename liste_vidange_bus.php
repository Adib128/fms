    ...
    <div class="container-fluid">
        <div class="container">
            <h3>
                ...
                ?>
                Historique vidange  - Véhicule : <?php echo $matricule_interne ?>
            </h3>
            <hr>
            ...
            <table class="table table-striped table-bordered" style="width:100%">
                <thead>
                    <tr>
                        <th class="col-xs-3">Date de vidange</th>
                        <th class="col-xs-2">Kilomètrage</th>
                        <th class="col-xs-2">Indexe</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    $liste = $db->query(
                            "SELECT * FROM vidange INNER JOIN bus ON  vidange.id_bus=bus.id_bus WHERE vidange.id_bus='$id' "
                    );
                    foreach ($liste as $row) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $row["indexe"]; ?></td>
                            <!-- <td align="center"> <a href="modifier_station.php?id=<?php echo $row["id_vidange"] ?>"><img src="img/update.png" width="35" height="35"></a> -->
                        </tr>
                        <?php
                    }
                    ?>
...
<script>
    $(document).ready(function () {
        var ch = "Historique vidange - Véhicule : <?php echo $matricule_interne ?>";
        $('.table-striped').last().DataTable({
            "bSort": false,
            dom: 'Bfrtip',
            buttons: [
                {

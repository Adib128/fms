...
<div id="page-wrapper">
    <div class="mx-auto flex flex-col gap-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="page-title">Liste des agences</h1>
                <p class="text-sm text-slate-500">Vue consolidée des agences et de leurs indicateurs clés.</p>
            </div>
            <div class="flex items-center gap-3">
                <a href="<?= url('ajouter-agence') ?>" class="btn-primary">
        ...
        <div class="panel">
            ...
            <div class="panel-body overflow-x-auto">
                ...
                <table class="table compact-table" id="tab">
                    ...
                    <tbody>
                        <?php
                        $liste = $db->query("SELECT * FROM station ORDER BY id_station ASC");
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="flex gap-1 justify-center">
                                        <a href="modifier_station.php?id=<?php echo $row["id_station"] ?>" class="btn-success py-1 px-2" title="Modifier agence">
                                            <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                                <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                            </svg>
                                        </a>
                                        <a href="supprimer_station.php?id=<?php echo $row["id_station"] ?>" onclick="return confirm('Voulez vous vraiment supprimer l\'agence ?');" class="btn-danger py-1 px-2" title="Supprimer agence">
                                            <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                <path d="M3 6h18"></path>
...
<script>
    $(document).ready(function () {
        ...
        var titreRapport = "Réseau des agences";

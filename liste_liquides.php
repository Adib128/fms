<?php
require 'header.php';
$liquidesStmt = $db->query('SELECT * FROM liquides ORDER BY id DESC');
...
<div id="page-wrapper">
    <div class="mx-auto flex max-w-9xl flex-col gap-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="page-title">Liste des liquides</h1>
                <p class="text-sm text-slate-500">Gérez les liquides et leurs types.</p>
            </div>
            <div class="flex flex-wrap items-center gap-3">
                <a href="<?= url('ajouter-liquides') ?>" class="btn-primary">
        ...
        <div class="panel min-h-[800px]">
            <div class="panel-heading">
                <span>Liquides enregistrés</span>
                <span class="badge">
                    <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M3 3v18h18" />
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="inline-flex items-center gap-2">
                                        ...
                                        <form method="POST" action="<?= url('supprimer-liquides') ?>" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce type de liquide ? Cette action est irréversible.');" style="display: inline;">
...
<script>
    $(function () {
        const titreRapport = 'Liste des liquides';

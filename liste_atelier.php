...
<div id="page-wrapper">
    <div class="mx-auto flex flex-col gap-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="page-title">Ateliers</h1>
                <p class="text-sm text-slate-500">Gestion des ateliers de maintenance.</p>
            </div>
            <div class="flex items-center gap-3">
                <a href="<?= url('ajouter-atelier') ?>" class="btn-primary">
        ...
        <div class="panel">
            ...
            <div class="panel-body overflow-x-auto">
                ...
                <div id="tableContainer" style="display: none;">
                    ...
                    <table class="table compact-table" id="ateliersTable">
                        <tfoot>
                            <tr>
                                <th>Nom</th>
                            </tr>
                        ...
                        <tbody>
                            <?php
                            try {
                                $stmt = $db->query("SELECT * FROM atelier ORDER BY nom ASC");
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="flex gap-1 justify-center">
                                                <a href="<?= url('modifier-atelier') ?>?id=<?= $row['id'] ?>" 
                                                ...
                                                <a href="<?= url('supprimer-atelier') ?>?id=<?= $row['id'] ?>" 
                                                   onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet atelier ?');" 
                                ...
                                echo '<tr><td colspan="2" class="text-center text-red-600">Erreur: ' . htmlspecialchars($e->getMessage()) . '</td></tr>';
                            }
                            ?>
                        </tbody>
                    </table>
...
$(document).ready(function () {
    var titreRapport = "Ateliers";

    const table = $('#ateliersTable').DataTable({
        bSort: false,
        deferRender: true,
        autoWidth: false,
        scrollX: false,
        ...
        initComplete: function (settings, json) {
            setTimeout(function() {
                try {
                    ...
                    $('#ateliersTable tfoot th').each(function (i) {
                        const $this = $(this);
                        if ($this.length) {

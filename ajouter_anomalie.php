...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            $_SESSION['message'] = "Anomalie ajoutée avec succès.";
...
<div id="page-wrapper">
    <div class="mx-auto flex flex-col gap-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="page-title">Ajouter une anomalie</h1>
            </div>
        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-10 gap-6 items-center">
                        ...
                        <div class="md:col-span-8">
                            <select name="id_system" id="id_system" class="w-full" required data-skip-tom-select="true">
                                ...
                                ?>
                                    <option value="<?= $sys['id'] ?>" <?= (isset($_POST['id_system']) && $_POST['id_system'] == $sys['id']) ? 'selected' : '' ?>>

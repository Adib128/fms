...
<div id="page-wrapper">
    <div class="mx-auto flex flex-col gap-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="page-title">Systèmes</h1>
                <p class="text-sm text-slate-500">Gestion des systèmes liés aux ateliers.</p>
            </div>
            <div class="flex items-center gap-3">
                <a href="<?= url('ajouter-systeme') ?>" class="btn-primary">
        ...
        <div class="panel">
            ...
            <div class="panel-body overflow-x-auto">
                ...
                <div id="tableContainer" style="display: none;">
                    ...
                    <table class="table compact-table" id="systemeTable">
                        <tfoot>
                            <tr>
                                <th>Désignation</th>
                                <th>Atelier</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="flex gap-1 justify-center">
                                                <a href="<?= url('modifier-systeme') ?>?id=<?= $row['id'] ?>" 
                                                ...
                                                <a href="<?= url('supprimer-systeme') ?>?id=<?= $row['id'] ?>" 
...
$(document).ready(function () {
    var titreRapport = "Systèmes";

    const table = $('#systemeTable').DataTable({
        bSort: false,
        deferRender: true,
        autoWidth: false,
        scrollX: false,
        ...
        initComplete: function (settings, json) {
            setTimeout(function() {
                try {
                    ...
                    $('#systemeTable tfoot th').each(function (i) {
                        const $this = $(this);
                        if ($this.length) {
